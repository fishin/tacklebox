...
//        }
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.apiPath+'/reel/{id}', config: { handler: api.Reel.getReel, description: "get reel" } },
        { method: 'DELETE', path: settings.apiPath+'/reel/{id}', config: { handler: api.Reel.deleteReel, description: "delete reel" } },
        { method: 'POST', path: settings.apiPath+'/reel/{id}', config: { handler: api.Reel.updateReel, description: "update reel" } },
