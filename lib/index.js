...
//        }
    ...
    plugin.expose('getRunPids', utils.Run.getRunPids);
    ...
    plugin.expose('getUser', utils.User.getUser);
    plugin.expose('getUsers', utils.User.getUsers);
    plugin.expose('updateUser', utils.User.updateUser);
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.apiPath+'/job/{job_id}/run/{run_id}/pids', config: { handler: api.Run.getRunPids, description: "get run pids" } },
