...
//        }
    ...
    server.route([
        ...
        {
            method: 'GET',
            path: settings.apiPath+'/job/bylink/{link}',
            config: {
                handler: api.Job.getJobByLink,
                description: "get job by link",
                validate: {
                    params: {
        ...
        {
            method: 'GET',
            path: settings.apiPath+'/job/{jobId}/run/bylink/{link}',
            config: {
                handler: api.Run.getRunByLink,
                description: "get run by link",
                validate: {
                    params: {
                        jobId: Joi.string().guid().required(),
                        link: Joi.string().required()
        ...
        {
            method: 'GET',
            path: settings.apiPath+'/reel/bylink/{link}',
            config: {
                handler: api.Reel.getReelByLink,
                description: "get reel by link",
                validate: {
                    params: {
                        link: Joi.string().required()
                    }
