...
//        }
    ...
    plugin.route([
        ...
        { method: 'POST', path: settings.apiPath+'/queue', config: { handler: api.Queue.createQueue, description: "create queue" } },
        { method: 'GET', path: settings.apiPath+'/queue/{id}', config: { handler: api.Queue.getQueue, description: "get queue" } },
        { method: 'DELETE', path: settings.apiPath+'/queue/{id}', config: { handler: api.Queue.deleteQueue, description: "delete queue" } },
        { method: 'POST', path: settings.apiPath+'/queue/{id}', config: { handler: api.Queue.updateQueue, description: "update queue" } },
        { method: 'GET', path: settings.apiPath+'/queues', config: { handler: api.Queue.getQueues, description: "get queues" } }
    ]);
