...
exports.startRun = function (jobId) {
   ...
   if (job.scm) {
      ...
      if (job.scm.type === 'git' ) {
          ...
          //console.log(internals.Run.settings.plugins.reel.settings.reel.workspace);
   ...
   //internals.Run.settings.plugins.reel.settings.reel.dirpath = runsDir;
   //console.log(internals.Run.settings.plugins.reel);
   var createConfig = internals.Run.settings.plugins.reel.createRun(commands, runsDir);
   //console.log('running id: ' + createConfig.id);
   var runId = internals.Run.settings.plugins.reel.startRun(createConfig.id, runsDir);
   var updateJob = job;
