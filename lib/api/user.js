...
exports.getUserByName = function (request, reply) {
    ...
    var user = internals.User.getUserByName(request.params.name);
    return reply(user);
};
...
exports.createPasswordHash = function (request, reply) {
    ...
    var hash = internals.User.createPasswordHash(request.payload.password);
    return reply(hash);
};

exports.generatePassword = function (request, reply) {

    var password = internals.User.generatePassword(request.params.length);
