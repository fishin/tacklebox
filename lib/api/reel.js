...
exports.updateReel = function (request,reply) {
    ...
    var reel = internals.Reel.updateReel(request.params.reel_id, request.payload);
    reply(reel);
};

exports.getReel = function (request,reply) {

    var reel = internals.Reel.getReel(request.params.reel_id);
    reply(reel);
};

exports.getReelByName = function (request, reply) {

   var response = internals.Reel.getReelByName(request.params.name);
   reply(response);
};
