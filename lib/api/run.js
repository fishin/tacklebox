...
exports.startRun = function (request, reply) {
   ...
   var plugins = request.server.plugins;
   var response = internals.Run.startRun(plugins, request.params.job_id);
   reply(response);
};
/*
...
exports.getRun = function (request, reply) {
   ...
   var response = internals.Run.getRun(request.params.run_id);
   reply(response);
};
