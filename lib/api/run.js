...
exports.cancelPullRequest = function (request, reply) {
    ...
    var token = internals.Run.settings.github.token;
...
exports.getRunStats = function (request, reply) {
    ...
    var run = internals.Run.getRun(request.params.jobId, null, request.params.runId);
    var fillet = new Fillet({});
    var response = fillet.getRunStats(run);
    reply(response);
};

exports.getPreviousRun = function (request, reply) {

    var response = internals.Run.getPreviousRun(request.params.jobId, null, request.params.runId);
    reply(response);
};
...
exports.getPullRequestPreviousRun = function (request, reply) {
    ...
    internals.Run.getPullRequest(request.params.jobId, request.params.number, token, function (pr) {
        ...
        var response = internals.Run.getPreviousRun(request.params.jobId, pr, request.params.runId);
        reply(response);
    });
};
...
exports.getRunsStats = function (request, reply) {
    ...
    var runs = internals.Run.getRuns(request.params.jobId, null);
    var fillet = new Fillet({});
    var response = fillet.getRunsStats(runs);
    reply(response);
};
...
exports.getRunsStatsLimit = function (request, reply) {
    ...
    var runs = internals.Run.getRuns(request.params.jobId, null);
    var fillet = new Fillet({});
    var response = fillet.getRunsStats(runs, request.params.limit);
    reply(response);
};
...
exports.deleteRuns = function (request, reply) {
    ...
    var response = internals.Run.deleteRuns(request.params.jobId, null);
    reply(response);
};
...
exports.getTestResult = function (request, reply) {
    ...
    var response = internals.Run.getTestResult(request.params.jobId, request.params.runId);
    reply(response);
};
