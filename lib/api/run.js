...
module.exports = internals.Run = function (options) {
    ...
    internals.Run.getRunPid = utils.Run.getRunPid;
...
exports.getRunPid = function (request, reply) {

   var response = internals.Run.getRunPid(request.params.job_id, request.params.run_id);
   reply(response);
};
