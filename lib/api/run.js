...
module.exports = internals.Run = function (options) {
    ...
    this.getArchiveArtifact = utils.Run.getArchiveArtifact;
    //console.log(this);
};
...
exports.getArchiveArtifact = function (request, reply) {
   ...
   var response = internals.Run.getArchiveArtifact(request.params.jobId, request.params.runId, request.params.name);
   reply(response);
};
