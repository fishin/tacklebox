...
exports.createJob = function (request, reply) {
    ...
    internals.Job.createJob(request.payload, function (response) {
...
exports.updateJob = function (request, reply) {
    ...
    internals.Job.updateJob(request.params.jobId, request.payload, function (response) {
...
exports.getJobsStats = function (request, reply) {
    ...
    var fullJobs = [];
    var jobs = internals.Job.getJobs();
...
exports.getAllCommits = function (request, reply) {
    ...
    internals.Job.getAllCommits(request.params.jobId, function (commits) {
...
exports.getCompareCommits = function (request, reply) {
    ...
    internals.Job.getCompareCommits(request.params.jobId, request.payload.commit1, request.payload.commit2, function (commits) {
