...
module.exports = internals.Job = function (options) {
    ...
    internals.Job.getCommits = utils.Job.getCommits;
...
exports.startJob = function (request, reply) {
   ...
   var response = internals.Job.startJob(request.params.jobId);
   reply(response);
};
...
exports.getCommits = function (request, reply) {

   internals.Job.getCommits(request.params.jobId, function (commits) {
